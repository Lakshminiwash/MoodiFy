    ...
    if (loading) {
        return (
            <div className="playlist_container">
                <div className="playlist__loading">Loading songs...</div>
            </div>
        )
    }
        ...
        <div className="playlist_container">
                    ...
                    <div className="playlist__player">
                        ...
                        <div className="player__info">
                            ...
                            <div className="player__meta">
                                ...
                                <p className="player__track-info">{currentSongIndex + 1} of {songs.length}</p>
                            </div>
                        </div>
            ...
            <div className="playlist__list">
                {songs.map((song, index) => (
                    <div
                        key={index}
                        className={`playlist__item ${currentSongIndex === index ? 'active' : ''}`}
                        onClick={() => playSong(index)}
                    >
                        <div className="playlist__item-number">
                            {currentSongIndex === index ? (
                                <span className="playlist__playing">▶</span>
                            ) : (
                                <span>{index + 1}</span>
                            )}
                        </div>
                        ...
                        <div className="playlist__item-info">
                            ...
                            <p className="playlist__item-mood">{song.mood}</p>
                        </div>

                        <div className="playlist__item-mood-badge">
                            {song.mood}
                        </div>
                    </div>
                ))}
